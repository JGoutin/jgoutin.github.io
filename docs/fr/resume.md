---
title: CV
description: Architecte de solutions, expert freelance en logiciel Python, cloud AWS et DevOps
keywords: CV, curriculum, profil, compétences, architecte cloud, AWS, DevOps, Python, IA, LLM, freelance, consultant
---

<div class="no-print" markdown>
![Jérémy Goutin](../assets/photo.webp){ .hero-photo }
</div>

# Jérémy Goutin

**Architecte de solutions &middot; 10+ ans d'expérience &middot; 20+ projets réussis**

Expert freelance en logiciel, cloud et DevOps.

<span class="no-print">[:material-file-pdf-box: Télécharger le PDF](CV_JGoutin.pdf)</span>

| | |
|---|---|
| E-mail | [contact@jgoutin.dev](mailto:contact@jgoutin.dev) |
| Site web | [jgoutin.dev](https://jgoutin.dev) |
| LinkedIn | [linkedin.com/in/jgoutin](https://www.linkedin.com/in/jgoutin) |
| GitHub | [github.com/jgoutin](https://github.com/jgoutin) |
...
- **Amazon Bedrock** : Accès et intégration multi-modèles
...
**Techniques :** Architecture de solutions complètes, résolution de problèmes complexes, respect des bonnes pratiques, apprentissage rapide
**Savoir-être :** Haute autonomie, esprit critique, force de proposition, rigueur méthodologique

---

## Projets significatifs

### stdapi.ai : API Compatible OpenAI, Anthropic et Cohere pour les Services IA d'AWS (Août 2025-Aujourd'hui)

**Contexte** : Projet Freelance
**Réalisations** :

- Création d'une API open source permettant la compatibilité des SDK OpenAI, Anthropic et Cohere avec les services IA d'AWS et les modèles Amazon Bedrock
...
- Couche de compatibilité établissant un pont entre les SDK OpenAI, Anthropic et Cohere et plus de 100 modèles Amazon Bedrock ainsi que plusieurs services IA d'AWS
...
- Utilisation d'**Amazon Bedrock** pour l'accès à un portefeuille varié de modèles de langage
- Gouvernance stricte pour protéger les données de l'entreprise

**Technologies** : Amazon Bedrock, Python, RAG, LLM, IA
...
**Contexte** : Accelize - Développement Logiciel
**Réalisations** :
...
**Contexte** : Open Source - Développement Logiciel
**Réalisations** :
...
*JGoutin-dev SARL - 994495422 R.C.S. Paris, France*
