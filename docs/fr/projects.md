...
## :material-rocket-launch: stdapi.ai — API compatible OpenAI, Anthropic et Cohere pour les services IA d'AWS
...
API *open source* offrant la compatibilité des SDK OpenAI, Anthropic et
Cohere avec les services IA d'AWS et les modèles Amazon Bedrock.
...
OpenAI, Anthropic et Cohere à plus de 100 modèles Amazon Bedrock et à
plusieurs services IA d'AWS.
...
couvrent les conversations textuelles, la génération d'images et de vidéos,
le traitement audio et les *embeddings* vectoriels.
...
!!! abstract "Juillet 2025 – août 2025 &middot; Freelance"
    ...
    **Stack :** Amazon Bedrock, Python, RAG, LLM, IA
...
L'architecture s'appuie sur **Amazon Bedrock** pour l'accès à un portefeuille
