---
title: Resume
description: Solutions architect, freelance expert in Python software, AWS cloud and DevOps
keywords: resume, CV, profile, skills, cloud architect, AWS, DevOps, Python, AI, LLM, freelance, consultant
---
...
**Solutions Architect &middot; 10+ years of experience &middot; 20+ successful projects**

Freelance expert in software, cloud, and DevOps.

<span class="no-print">[:material-file-pdf-box: Download PDF](CV_JGoutin.pdf)</span>

| | |
|---|---|
| Email | [contact@jgoutin.dev](mailto:contact@jgoutin.dev) |
| Website | [jgoutin.dev](https://jgoutin.dev) |
...
- **Amazon Bedrock**: Multi-model access and integration
...
**Technical:** Complete solution architecture, complex problem solving, best practices compliance, fast learner
**Soft Skills:** High autonomy, critical thinking, proactive approach, rigorous methodology

---

## Significant projects

### stdapi.ai: OpenAI-, Anthropic- & Cohere-Compatible API for AWS AI Services (August 2025-Present)

**Context**: Freelance Project
**Achievements**:

- Creation of an open-source API enabling OpenAI, Anthropic, and Cohere SDK compatibility with AWS AI services and Amazon Bedrock models
...
- Compatibility layer bridging OpenAI, Anthropic, and Cohere SDKs with 100+ Amazon Bedrock models and multiple AWS AI services
...
- Use of **Amazon Bedrock** for access to a varied portfolio of language models
- Strict governance to protect company data

**Technologies**: Amazon Bedrock, Python, RAG, LLM, AI
...
**Context**: Accelize - Software Development
**Achievements**:
...
**Context**: Open Source - Software Development
**Achievements**:
