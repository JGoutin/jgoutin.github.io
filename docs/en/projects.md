...
## :material-rocket-launch: stdapi.ai — OpenAI-, Anthropic- & Cohere-compatible API for AWS AI services
...
Open-source API providing OpenAI, Anthropic, and Cohere SDK compatibility with
AWS AI services and Amazon Bedrock models.
...
The solution provides a compatibility layer bridging the OpenAI, Anthropic,
and Cohere SDKs with 100+ Amazon Bedrock models and several AWS AI services.
...
text conversations, image and video generation, audio processing, and vector
embeddings.
...
!!! abstract "July 2025 – August 2025 &middot; Freelance"
    ...
    **Stack:** Amazon Bedrock, Python, RAG, LLM, AI
...
The architecture relies on **Amazon Bedrock** for access to a diverse portfolio
of language models.
